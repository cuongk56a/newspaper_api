...
from .serializers import CategorySerializer, SourceSerializer, PostShortSerializer, PostSerializer
...
class PostViewSet(BaseViewSet):
    ...
    def retrieve(self, request, *args, **kwargs):
        instance = Post.objects.select_related('category', 'source').prefetch_related('contents', 'keywords').get(id=kwargs['pk'])
