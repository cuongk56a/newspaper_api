...
model_file = os.path.join(core.settings.BASE_DIR, './machine_learning/model/model_test1')
encoder_file = os.path.join(core.settings.BASE_DIR, './machine_learning/encoder.pkl')
